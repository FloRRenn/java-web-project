...
public class CinemaHallController {
	...
	@GetMapping("/{hall_id}")
	@Operation(	      
			summary = "Get Hall By ID Information (Admin is required)",					
			responses = {
					@ApiResponse( responseCode = "200", description = "Hall's information.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = CinemaHall.class))),
					@ApiResponse( responseCode = "404", description = "Hall is not found.",
	...
	@GetMapping("/getall")
	@Operation(
			summary = "Getall Hall Service (User is required)",					
			responses = {
					@ApiResponse( responseCode = "200", description = "List Hall's information.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = CinemaHall.class))),
			},
			parameters = {
					@Parameter( name = "Authorication", in = ParameterIn.HEADER,
	...
	@PutMapping("/new")
	@Operation(
			summary = "Add a New Hall Service (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Add a new hall successfully.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = MyApiResponse.class))),
					@ApiResponse( responseCode = "400", description = "This hall is existed or Illegal characters in name or Row/Column number must be greater than 5.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
			},
			parameters = {
					@Parameter( name = "Authorication", in = ParameterIn.HEADER,
	...
	@Operation(
			summary = "Delete Hall Service (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Delete Hall successfully.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = MyApiResponse.class))),
					@ApiResponse( responseCode = "404", description = "Hall is not found.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
			},
	...
	@Operation(
			summary = "Edit Hall Service (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Edit hall successfully.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = MyApiResponse.class))),
					@ApiResponse( responseCode = "400", description = "Illeagal charaters in name.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
					@ApiResponse( responseCode = "404", description = "Hall is not found.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
			},
	...
	@Transactional
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<?> edit(@PathVariable(value = "hall_id") String hall_id, @RequestBody CinemaHallRequest cReq) {
		return ResponseEntity.ok().body(hallSER.editHall(hall_id, cReq));
	}
	
	@GetMapping("/{hall_id}/seat/getall")
	@Operation(
			summary = "Get All Seat In Hall (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Seat's in hall information.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = SeatsResponse.class))),				
			},
			parameters = {
					@Parameter( name = "Authorication", in = ParameterIn.HEADER,
							schema = @Schema(type = "string"), example = "Bearer <token>",
	...
	@Operation(
			summary = "Edit Seat In Hall Service (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Edit seat in hall successfully.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = MyApiResponse.class))),
					@ApiResponse( responseCode = "404", description = "Seat not found or Type is not found or Status is not found.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
			},
			parameters = {
					@Parameter( name = "Authorication", in = ParameterIn.HEADER,
	...
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<?> getall(@PathVariable(value = "hall_id") String hall_id, @RequestBody SeatEditRequest cReq) {
