...
public class GenreController {
	...
	@GetMapping("/getall")
	@Operation(
			summary = "Get All Genre Service",
			responses = {
					@ApiResponse( responseCode = "200", description = "Genre's information.",
	...
	@Operation(
			summary = "Genre ID",
			responses = {
					@ApiResponse( responseCode = "200", description = "Genre's ID information.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = Genre.class))),
					@ApiResponse( responseCode = "404", description = "Genre ID is not found.",
	...
	@Operation(
			summary = "Name genre",
			responses = {
					@ApiResponse( responseCode = "200", description = "Genre's name information.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = Genre.class))),
					@ApiResponse( responseCode = "404", description = "Genre name is not found.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
			}      
...
//For ADMIN role:
	...
	@PostMapping("/add")
	@Operation(
			summary = "Add Genre Service (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Add genre successfully.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = Genre.class))),
					@ApiResponse( responseCode = "400", description = "This genre is existed.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
			},
			parameters = {
	...
	@Operation(
			summary = "Add Genre Service (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Add list genre successfully.",
	...
	@Operation(
			summary = "Update Genre Service (Admin is required)",
			responses = {
					@ApiResponse( responseCode = "200", description = "Update genre successfully.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = Genre.class))),
					@ApiResponse( responseCode = "400", description = "Can update this name becasue another genre has this one.",
							content = @Content( mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
